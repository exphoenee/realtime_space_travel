...
>
> A prefix elhagyása (nem-`VITE_` név), a kulcs rotálása és a **restricted API key** bevezetése a [[009-stripe-fraud-defense]] terv A fázisának feladata.
