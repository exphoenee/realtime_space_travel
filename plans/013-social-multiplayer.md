...
- [[021-stripe-fraud-defense]] / [[024-stripe-go-live]] — **közvetve érintett.** A rules-teszt infrastruktúra (U. blokk) az első a projektben; a `wallet` szabályok jövőbeli szigorítása ugyanezt a keretet fogja használni.
