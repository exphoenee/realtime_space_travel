...
> ⚠️ **Ez a terv semmitől nem függ.** `dependencies: []` — **szándékosan üres**. A magas sorszám (021) csak az időrendet tükrözi, **nem** függőséget: ez a terv **bármikor implementálható**, akár azonnal, a [[018-nextjs-migration]] **előtt** is. Egy későbbi olvasó ne higgye, hogy a Next.js migrációra vár. Az egyetlen kapcsolódás a 018-hoz egy **kódütközési figyelmeztetés** (6.12), nem függőség.
...
- **`dependencies: []` — ez a terv semmitől nem függ.** Nincs előfeltétele, bármikor implementálható. A 021-es sorszám **időrend**, nem sorrendi kényszer.
