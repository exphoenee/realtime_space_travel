...
>
> **Követő tervek:** [[005-ingame-shop-strapi-stripe]] (Stripe Payment Links, kliensoldali kredit-írás), [[016-stripe-fraud-defense]] (Spark-kompatibilis csalásvédelem, opcionális serverless webhook)

- [~] `awardWage` + `purchaseWithCredits` Cloud Functionök → ~~eltávolítva, lásd [[005-ingame-shop-strapi-stripe]] + [[016-stripe-fraud-defense]]~~
